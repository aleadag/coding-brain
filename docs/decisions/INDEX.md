...
| [ADR-0006](ADR-0006-use-sqlite-for-brain-and-lifecycle-state.md) | Accepted | Make SQLite the atomic Brain and lifecycle authority store while isolating operational review state and retaining explicit legacy export. |
